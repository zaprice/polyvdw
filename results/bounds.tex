...
The method described could potentially be extended to higher-degree polynomials or progressions longer than two, but there are additional complications.
...
are simply $PW(4, \{n\cdot g\}) \leq n\cdot g(n\cdot w)+1$,
